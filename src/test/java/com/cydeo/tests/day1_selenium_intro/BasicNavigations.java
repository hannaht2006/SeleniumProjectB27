...
public class BasicNavigations {
    public static void main(String[] args) throws InterruptedException {
        ...
        //pausing execution of code for 3 sec.
        Thread.sleep(3000);//add InterruptedException to handle the check exception sleep()
        ...
        //close() method will cloe current opened page
        driver.close();

        //quit() method will close all of opened pages
        driver.quit();
